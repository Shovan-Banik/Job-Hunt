        ...
        <div className=' bg-gradient-to-r from-purple-50 to-purple-100 pt-12'>
                <div className='my-container gap-8 flex xs:flex-col flex-col-reverse md:flex-row'>
                    <div className='md:w-1/2 text-center'>
                        <h1 className='text-5xl font-bold md:pt-16'>One Step<br/>Closer To Your <br /><span className='text-indigo-500'>Dream Job</span></h1>
                    ...
                    <div className='md:w-1/2 md:relative'>
                        <img className='md:absolute md:bottom-0'  src={pic} alt="" />
                    </div>
                </div>
            </div>
    );
